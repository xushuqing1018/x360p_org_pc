...
export default {
    bind: function (element, binding,vnode) {
        ...
        if(_.isObject(binding.value)){
            ...
            selector = binding.expression
        }
        $(element).on('click',function(e){
            $(selector).printArea({extraCss:'http://sp1.xiao360.com/css/printarea.css'})
        })
    }
  }
 ...
 */
 function installjQueryPlugin(jQuery){
    if(jQuery.fn.printArea){
        return;
    }
    (function($) {
        var counter = 0;
