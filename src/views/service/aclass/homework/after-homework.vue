<template>
	<div>
		...
		<div class="box box-result">
			<div class="toolbar">
				<Button type="primary" @click.native="homeworkAdd" v-per="'homework.add'" v-if="!enable_regular_homework">布置作业</Button>
				
				<Dropdown v-if="enable_regular_homework">
		...
		data () {
			return {
				...
				column_render: {
					...
					deadline (h,params) {
						let time = this.$filter('int_date')(params.row.deadline),
