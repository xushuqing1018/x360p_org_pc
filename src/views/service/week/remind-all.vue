<template>
	<div class="c-grid">
		<div class="box box-query">
			...
			<Row class="basic">
                <Col span="12" class="mt-2" style="margin-left:0px;">                	
                	<Button-group>
				...
				<Col span="12">
					...
					<Button class="pull-right m-t-5 mr-4" type="ghost" @click="showTaskConfig" icon="ios-gear-outline">自动提醒计划</Button>
                </Col>
          	</Row>
		</div>
		            ...
		            <table class="modal-table">
	            		<thead>
	            			<tr>
								...
								<th><div class="ivu-table-cell">对象类型</div></th>
								<th><div class="ivu-table-cell">服务类型</div></th>
	            				<th width="500"><div class="ivu-table-cell">服务标准</div></th>
								<th width="100"><div class="ivu-table-cell">服务对象</div></th>
	            			</tr>
	            		</thead>
	            		<tbody>
...
<script>
	...
	export default {
		...
		methods: {
			...
			showTaskConfig() {
				this.$Modal.open('service/week/task-config-modal.vue')
				.then(modal => {
					modal.show('服务提醒自动提醒计划配置')
				})
			},
		}
	}
