	...
	<div class="c-grid">
		<div class="box box-query">
			<Form ref="ref_search" :model="search_field" :label-width="80" class="filter-form row">
				<Form-item label="校区" prop="branch_name" class="col-sm-3">
					<Input v-model="search_field.branch_name" placeholder="校区名称"></Input>
				</Form-item>
			...
			<Row class="basic">
	            <Col span="24" class="mt-2">
                	...
                	<export-button res="report_branch_summarys" :params="report_params" v-per="'reports.export'"></export-button>
					<Button type="primary" icon="refresh" @click="refreshData">刷新</Button>
		...
		<div class="box box-result">
	        ...
	        <div class="content">
				<div class="content-body">
			        <Table 
			        v-loading="'report_branch_summarys'" 
			        :page-size="pageSize" 
			        :page="pageIndex" 	
			        :stripe="true" 
			        :show-header="true" 
...
<script>
	...
	export default{
		...
		data () {
			return {
				rest_api: 'report_branch_summarys',
				search_field: {
					branch_name: '',
					int_day: [],
					branch_mode: 0
			...
			report_params() {
				...
				if(int_day!=','&&int_day.length>0) {
					params = {
						...
						end_date: int_day[1],
						branch_name: this.search_field.branch_name,
						branch_mode: this.search_field.branch_mode
					}
				}
				return params
			}
