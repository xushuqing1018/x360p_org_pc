		...
		<div class="c-grid p-0">		
			<div class="box box-query">
				<Form ref="ref_search" :model="search_field" :label-width="80" class="filter-form row">
					<Form-item label="到离校日期" prop="int_day" class="col-sm-5">
						<date-range-picker 
					...
					<Form-item label="学员" prop="sid" class="col-sm-5">
	...
	export default{
		...
		methods: {
			...
			customAttendPost (value,leave) {
				...
				if(this.mode=='arrive'&&typeof leave=='undefined'){
					params.is_attend = 1
					msg = '到校提醒成功'
				}else{
					params.is_leave = 1
