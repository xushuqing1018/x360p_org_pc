<template>
    <div :class="classes">
        ...
        <select-material-modal v-model="modalShow" :multiple="multiple" :selected="model" :width="modalWidth" :binding="binding" @on-select="updateSelected">
        </select-material-modal>
    </div>
</template>
<script>
import { oneOf, findComponentDownward } from '@/libs/assist';
import SelectMaterialModal from './SelectMaterialModal.vue'
