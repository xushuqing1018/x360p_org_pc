<template>
    <div :class="classes">
        ...
        <select-learn-package-modal v-model="modalShow" :multiple="multiple" :selected="model" :width="modalWidth" @on-select="updateSelected">
        </select-learn-package-modal>
    </div>
</template>
<script>
import { oneOf, findComponentDownward } from '@/libs/assist';
import SelectLearnPackageModal from './SelectLearnPackageModal.vue'
...
const recordName = '学习套餐'
const unit       = '个'

export default {
        name: 'allLearnPackage',
        components: {
            SelectLearnPackageModal
        },
        props: {
            value: {
