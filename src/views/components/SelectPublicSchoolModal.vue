    		...
    		<div class="list-main">
                <div class="list-condition">
                	<Row>
                		<Col span="8">
                			<Input 
                                v-model="search_field.school_name" 
                                size="small" 
                                placeholder="学校名称" 
                                v-focusme="'searchkey'" 
                        ...
                        <table class="table-list">
                            <thead>
                                <tr>
                                    ...
                                    <th><div class="ivu-table-cell">公立学校名称</div></th>
                            ...
                            <tbody>
                                <tr :class="{'table-info':item.$selected}" @click="toggleSelected(item)" v-for="item in data">
                                    ...
                                    <td><div class="ivu-table-cell">{{item.school_name}}</div></td>
                                    <td><div class="ivu-table-cell">{{item.address}}</div></td>
                                </tr>
                                <tr v-if="data.length == 0">
                                    <td colspan="5" style="text-align: center"><p class="empty">没有合适的学校</p></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <Card>
                    ...
                    <ul class="multi-selected-list">
                        <li style="display: flex; align-items: center" v-for="item in selectedList">
                            <span style="flex: 0 0 190px">{{item.school_name}}</span>
...
const resName   = 'public_schools'
const idField   = 'ps_id'
const textField = 'school_name'
export default {
	name:'PublicSchoolList',
    ...
    watch: {
        'modal$.show': function (val){
        	if(val){
                ...
                if(this.search_field.school_name != ''){
                    this.search_field.school_name = ''
