<template>
	<div class="x-calendar">
		<!-- header pick month -->
		<x-header :current-month="currentMonth" :first-day="firstDay" :locale="locale" @change="emitChangeMonth">
				...
				<div class="dates-events">
					<div class="events-week" v-for="week in currentDates">
						<div 
							...
							<slot name="extra" :event="day"></slot>
						</div>
					</div>
				</div>
...
<script>
	...
	import dateFunc from './components/date-func'
