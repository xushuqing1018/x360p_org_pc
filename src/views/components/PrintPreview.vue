	...
	export default{
			...
			return {
				...
				data: {
					...
					order:{
						...
						refund_amount_b: '贰仟元整 [现金：2000.00]',
						...
						class_name: '书法速成班',
						lesson_name: '硬笔字初级',
						lesson_time: '2018-10-17 20:00-21:00',
						room_name: '罗湖教室1002',
						second_teacher_name: '',
						subject_name: '英语',
						teacher_name: '测试1',
						consume_lesson_hours: '2.00',
						remain_lesson_hours: '98.00'
					},
					bs: {
						student_name: '小明',
						sno: 'S123456',
		...
		methods: {
			...
			print () {
				...
				this.printer.print(htmls,cssLinks,page,driver)
			}
		},
		computed: {
			margin () {
