    	...
    	<div :class="classes">
    		<div class="list-main">
                <div class="list-condition">
                	<Row>
                		<Col span="8">
                			<Input v-model="params.search_value" size="small" placeholder="套餐名称" v-focusme="'searchkey'"></Input>
                		</Col>
                		<Col span="10">
                			<ButtonGroup>
                ...
                <div class="list-body">
                    <div class="list-body-wrap" v-loading.like="'lesson_suit_defines'">
                        <table class="table-list">
                            <thead>
                                <tr>
                                    ...
                                    <th><div class="ivu-table-cell">套餐名称</div></th>
                                    <th><div class="ivu-table-cell">套餐内容</div></th>
                                    <th><div class="ivu-table-cell">创建人</div></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr :class="{'table-info':item.$selected}" @click="toggleSelected(item)" v-for="item in data">
                                    ...
                                    <td><div class="ivu-table-cell">
                                    	<p style="color: #999;line-height: 1.5" v-for="data in item.define">
                                    		{{labelDicts(data.product_level_did,'product_level')}},
                                    		{{data.must?'必报':'非必报'}},
                                    		课程数{{data.nums}}
                                    	</p>
                                    </div></td>
                                    <td><div class="ivu-table-cell">
                                    	{{item.create_uid|ename}}
                                    </div></td>
                                </tr>
                                <tr v-if="data.length == 0">
                                    <td colspan="5" style="text-align: center"><p class="empty">没有合适的学习套餐</p></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
const resName   = 'lesson_suit_define'
const idField   = 'lsd_id'
const textField = 'name'
export default {
	name:'learnPackageModal',
    ...
    mounted() {
        this.rest_api = util.sprintf('lesson_suit_defines?bid=[in,0,%s]',this.bid$)
