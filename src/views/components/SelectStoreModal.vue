    	...
    	<div :class="classes">
    		<div class="list-main">
                <div class="list-condition">
                	<Row>
                		<Col span="8">
                			<Input v-model="search_field.name" size="small" placeholder="仓库名称" v-focusme="'searchkey'"></Input>
                		</Col>
                		<Col span="10">
                			<ButtonGroup>
                        ...
                        <table class="table-list">
                            <thead>
                                <tr>
                                    ...
                                    <th><div class="ivu-table-cell">仓库名称</div></th>
                                    <th><div class="ivu-table-cell">类型</div></th>
                                    <th><div class="ivu-table-cell">关联校区</div></th>
                            ...
                            <tbody>
                                ...
                                <tr v-if="data.length == 0">
                                    <td colspan="5" style="text-align: center"><p class="empty">没有合适的仓库</p></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
