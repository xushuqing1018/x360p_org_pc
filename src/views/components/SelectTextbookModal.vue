                        ...
                        <table class="modal-table">
                            <thead>
                                <tr>
                                    ...
                                    <th><div class="ivu-table-cell">教材名</div></th>
                                    <th><div class="ivu-table-cell">出版机构</div></th>
                            ...
                            <tbody>
                                <tr :class="{'table-info':item.$selected}" @click="toggleSelected(item)" v-for="item in data">
                                    ...
                                    <td><div class="ivu-table-cell">{{item.tb_name}}</div></td>
                                    <td><div class="ivu-table-cell">{{item.tb_org_name}}</div></td>
                                    <td><div class="ivu-table-cell">{{item.create_time|date}}</div></td>
                                </tr>
                                <tr v-if="data.length == 0">
                                    <td colspan="5" style="text-align: center"><p class="empty">没有可用的教材</p></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
const resName   = 'textbook'
const idField   = 'tb_id'
const textField = 'tb_name'

const gvarName  = 'textbooks'
export default {
	name:'TextbookList',
