 	...
 	<div class="c-grid">
	    <div class="box box-query">
	    	<Form ref="ref_search" :model="search_field" :label-width="70" class="filter-form row">
				...
				<Form-item label="老师" prop="teach_eid" class="col-md-3 col-sm-6">
	        ...
	        <Row class="basic">
	            <Col span="24" class="mt-2">
                    ...
                    <div class="pull-right" v-if="perCheckAllClass">
                        <label>权限范围：</label>
                        <ButtonGroup>
                            <Button type="ghost" size="large" icon="android-person" @click="trunMyClass">我的</Button>
                            <Button type="primary" size="large" icon="android-people">所有</Button>
                        </ButtonGroup>
                    </div>
                    <!--
                    <div class="pull-right mr-4">
                        <label>当前模式：</label>
                        <ButtonGroup>
                            <Button type="primary" size="large" icon="ios-list-outline">列表</Button>
                            <Button type="ghost" size="large" icon="grid" @click="turnGridClass">表格</Button>
                        </ButtonGroup>
                    </div>
                    -->
	            </Col>
        ...
        data() {
            return {
                ...
                operation_func:{
                    ...
                    arrange(params){
                        this.dr().getData(util.sprintf(CLASS_SCHEDULES_URL,params.row.cid),false)
                        .then(response=>{
