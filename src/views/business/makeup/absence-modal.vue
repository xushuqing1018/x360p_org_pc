	...
	<Modal v-drag-modal v-model="modal$.show" :mask-closable="false" width="900" :title="modal$.title" @on-cancel="cancel">
		<div :class="classes" v-if="modal$.show">
    		<div class="list-main">
                ...
                <div class="list-body">
                    <div class="list-body-wrap" v-loading.like="'student_absences'">
                        <table class="x-modal-table modal-table">
                            <thead>
                                <tr>
                                    ...
                                    <th><div class="ivu-table-cell">缺课时间</div></th>
                                </tr>
                            </thead>
                            <tbody>
...
<script>	
	...
	export default {
		...
		data() {
			return {
				rest_api: 'student_absences?status=0',
				modalShow: false,
				selIds: [],
				is_data_init:false,
				search_field: {
...
//			this.init_data()
		...
		methods: {
			...
			hook_get_param (params) {
				...
				params.with = 'student,one_class,student_lesson'
