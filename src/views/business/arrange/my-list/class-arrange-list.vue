<template>
	<div>
		...
		<div class="box box-result">
			<div class="toolbar">
				<span v-if="info.name" style="line-height:2.2">【{{info.name}}】的排课：</span>
				<Button type="primary" icon="plus" @click="addArrange">添加排课</Button>
	        ...
	        edit(row){
				let obj = util.copy(row),
					...
					classInfo = {
	            		cid: row.cid,
	            		lid: row.lid,
	            		class_name: row.one_class.class_name
	            	},
	            	tip = util.sprintf(
						'调整排课时间:%s %s~%s',
