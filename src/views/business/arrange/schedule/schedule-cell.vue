...
<template>
	<Tooltip placement="bottom" class="course-tooltip">
		<div slot="content">{{course_students}}</div>
		<div 
			:class="['cell-wrap',background_color,{cancel:data.is_cancel==1}]" 
			@click.stop="showDetail" 
			@mouseenter="getCourseStudents"
			>
			<div v-if="view!=='section'">{{formatSection(data)}}</div>
			<div v-if="view!=='class'">
