		...
		<div class="box box-query">
    		...
    		<Row class="basic">
                <Col span="24" class="mt-2" style="margin-left:0px;">  
	            	...
	            	<export-button res="report_class_by_names" :params="params"></export-button>             	
                </Col>
            </Row>
		</div>
		<div class="box box-result">
	        ...
	        <div class="content">
                <div class="content-body">
                    <Table 
                    v-loading.like="'report_class_by_names'" 
                    ref="tableExcel"
                    :pageSize="pageSize" 
                    :page="pageIndex" 
                    :stripe="true" 
...
<script>
	...
	export default {
		...
		data() {
			return {
				rest_api: 'report_class_by_names',
				search_field: {
					lid: 0
				},
				column_keys: {
