    ...
    <div>
        <div class="box box-query">
            <Form ref="ref_search" :label-width="70" :model="search_field" class="filter-form row">
                ...
                <Form-item label="助教" prop="eid" class="col-md-3 col-sm-6">
                    <select-employee :rid="2" v-model="search_field.eid" clearable :placeholder="label_choose_teacher"></select-employee>
                </Form-item>
            </Form>
            <Row class="basic">
                ...
                <export-button res="report_attendance_by_secondeids" :params="params"></export-button>
                </Col>
            </Row>
        </div>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                rest_api: 'report_attendance_by_secondeids',
                search_field: {
