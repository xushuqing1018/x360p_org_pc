<template>
	<Dropdown trigger="click">
		...
		<DropdownMenu slot="list">
            ...
            <DropdownItem v-per="'employees.leave'" @click.native="leave" v-if="info.is_on_job == 1">
            	<Icon type="arrow-return-left"></Icon>　{{'老师'|translate}}离职
            </DropdownItem>
            <DropdownItem @click.native="checkoutFreeTime" v-if="info.is_on_job == 1">
            	<Icon type="ios-time-outline"></Icon>　空闲时间
            </DropdownItem>
        </DropdownMenu>
	</Dropdown>
</template>
