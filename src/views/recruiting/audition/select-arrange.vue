<template>
	<Modal v-drag-modal v-model="modal$.show" :title="modal$.title" :mask-closable="false" width="850">
		<Form ref="ref_search" :model="search_field" :label-width="70" class="filter-form row">
        	<Form-item label="试听课" prop="name" class="col-md-4 col-sm-6" v-if="isTrial">
        		<Input v-model="search_field.name" clearable placeholder="试听课名称"></Input>
        	</Form-item>
        	<Form-item label="班级名称" prop="cid" class="col-md-4 col-sm-6" v-if="!isTrial && enable_lesson_type0">
        		<select-class v-model="search_field.cid" clearable></select-class>
        	</Form-item>
        	<Form-item label="课程名称" prop="lid" class="col-md-4 col-sm-6" v-if="!isTrial">
